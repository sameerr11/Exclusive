  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <ProductHero
        ...
        title="EV Ticket Support System"
        description="Deliver exceptional customer support with AI-powered ticketing, multi-channel integration, and real-time analytics."
        demoLink="https://evtss-demo.exclusivevision.com"
        image="/EV TICKET.png"
        imageAlt="EV Ticket Support System"
        pattern="hexagon"
      />
