        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-start mb-8 lg:mb-16">
            ...
            <div>
              ...
              >
                Secure and intelligent document management solution designed to organize, store,
                and retrieve documents efficiently with advanced search, version control, and compliance features.
              </motion.p>
                ...
                {[
                  {
                    ...
                    description: "Centralized storage with intelligent categorization and folder structures for easy management."
                  },
                  {
                    icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
                    title: "Advanced Search & Retrieval",
                    description: "Powerful full-text search and metadata filtering for quick document discovery."
                  },
                  {
                    icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
                    title: "Version Control & Audit Trail",
                    description: "Track document versions and maintain a complete audit trail for compliance."
                  }
                ].map((feature, index) => (
                  <motion.div
                    key={index}
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-primary to-accent text-white py-10 sm:py-12 lg:py-16 rounded-2xl lg:rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
                ...
                >
                  Experience the power of EV Document Management System and take control of your documents.
                </motion.p>

                <motion.a
                  href="https://your-ev-dms-url.com"
                  target="_blank"
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  Access EV Document Management System →
                </motion.a>
              </div>
            </div>
          </div>
