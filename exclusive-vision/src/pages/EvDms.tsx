  ...
  const features = [
    {
      ...
      description: "AI-powered categorization and intelligent folder structures"
    },
    {
      icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
      title: "Advanced Search",
      description: "Full-text search with OCR and metadata filtering"
    },
    {
      icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
      title: "Version Control",
      description: "Complete version history with rollback capabilities"
    },
    {
    ...
    },
    {
      ...
      title: "AI Processing",
      description: "Automated data extraction and document classification"
    },
    {
          ...
          <ScrollReveal>
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                Everything you need to manage, organize, and secure your documents
              </p>
            </div>
          </ScrollReveal>
